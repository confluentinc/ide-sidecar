...
public class ClientConfigurator {
  ...
  static Map<String, Object> getKafkaClientConfig(
      ConnectionState connection, KafkaCluster cluster, SchemaRegistry sr, boolean redact,
    ...
    connection.getKafkaCredentials(cluster.id()).flatMap(
        creds -> creds.kafkaClientProperties(options)).ifPresent(props::putAll);
  ...
  static Map<String, Object> getSchemaRegistryClientConfig(
      ConnectionState connection, SchemaRegistry sr, boolean redact
  ) {
    ...
    connection.getSchemaRegistryCredentials(sr.id()).flatMap(
        creds -> creds.schemaRegistryClientProperties(options)).ifPresent(props::putAll);
    return props;
  }
  ...
  public Map<String, Object> getAdminClientConfig(
      String connectionId, String clusterId, boolean redact
  ...
  public Map<String, Object> getConsumerClientConfig(
      String connectionId, String clusterId, boolean includeSchemaRegistry, boolean redact
  ) throws ConnectionNotFoundException, ClusterNotFoundException {
    return getKafkaClientConfig(connectionId, clusterId, includeSchemaRegistry, redact,
        Map.of("session.timeout.ms", "45000")
    );
  }
  ...
  protected Map<String, Object> getKafkaClientConfig(
    ...
    return getKafkaClientConfig(connection, cluster, sr, redact, defaultProperties);
  }
  ...
  public Map<String, Object> getSchemaRegistryClientConfig(
      String connectionId, String schemaRegistryId, boolean redact
  ) throws ConnectionNotFoundException, ClusterNotFoundException {
    // Find the cluster using the connection ID, and fail if either does not exist
