...
public class SchemaRegistryClusterProxyContext extends ClusterProxyContext {

  public SchemaRegistryClusterProxyContext(String requestUri, MultiMap requestHeaders,
