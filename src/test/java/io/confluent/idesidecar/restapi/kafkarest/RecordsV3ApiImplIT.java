...
class RecordsV3ApiImplIT {
  ...
  @Tag("io.confluent.common.utils.IntegrationTest")
  @TestProfile(NoAccessFilterProfile.class)
  class DryRunPathWithLocal extends DryRunPath {
  ...
  @Tag("io.confluent.common.utils.IntegrationTest")
  @TestProfile(NoAccessFilterProfile.class)
  class DryRunPathWithDirect extends DryRunPath {
  ...
  abstract class DryRunPath extends AbstractSidecarIT {

    @Test
    void shouldDryRunProduceRecord() {
      var topicName = randomTopicName();
      createTopic(topicName);
    ...
    @Test
    void shouldDryRunWithInvalidData() {
      var topicName = randomTopicName();
      createTopic(topicName);
