...
public class SchemaRegistryContainer extends GenericContainer<SchemaRegistryContainer> {
  ...
  public Map<String, String> getSchemaRegistryEnv() {
    ...
    envs.put("SCHEMA_REGISTRY_KAFKASTORE_SASL_LOGIN_CALLBACK_HANDLER_CLASS",
    ...
    envs.put("SCHEMA_REGISTRY_KAFKASTORE_SASL_JAAS_CONFIG", """
        ...
        """);
    envs.put("SCHEMA_REGISTRY_KAFKASTORE_SSL_TRUSTSTORE_LOCATION",
        "/etc/kafka/secrets/kafka.schemaregistry.truststore.jks");
    envs.put("SCHEMA_REGISTRY_KAFKASTORE_SSL_TRUSTSTORE_PASSWORD", "confluent");
    envs.put("SCHEMA_REGISTRY_KAFKASTORE_SSL_KEYSTORE_LOCATION",
        "/etc/kafka/secrets/kafka.schemaregistry.keystore.jks");
    ...
    envs.put("SCHEMA_REGISTRY_SSL_TRUSTSTORE_LOCATION",
        "/etc/kafka/secrets/kafka.schemaregistry.truststore.jks");
    envs.put("SCHEMA_REGISTRY_SSL_TRUSTSTORE_PASSWORD", "confluent");
    envs.put("SCHEMA_REGISTRY_SSL_KEYSTORE_LOCATION",
        "/etc/kafka/secrets/kafka.schemaregistry.keystore.jks");
    ...
    envs.put("SCHEMA_REGISTRY_SCHEMA_REGISTRY_RESOURCE_EXTENSION_CLASS",
        "io.confluent.kafka.schemaregistry.security.SchemaRegistrySecurityResourceExtension,io.confluent.schema.exporter.SchemaExporterResourceExtension");
    envs.put("SCHEMA_REGISTRY_CONFLUENT_SCHEMA_REGISTRY_AUTHORIZER_CLASS",
        "io.confluent.kafka.schemaregistry.security.authorizer.rbac.RbacAuthorizer");
    envs.put("SCHEMA_REGISTRY_REST_SERVLET_INITIALIZOR_CLASSES",
    ...
    // Hardcoded values
    envs.put("SCHEMA_REGISTRY_CONFLUENT_METADATA_BOOTSTRAP_SERVER_URLS",
        "https://kafka1:8091,https://kafka2:8092");
    envs.put("SCHEMA_REGISTRY_CONFLUENT_METADATA_HTTP_AUTH_CREDENTIALS_PROVIDER", "BASIC");
    envs.put("SCHEMA_REGISTRY_CONFLUENT_METADATA_BASIC_AUTH_USER_INFO",
        "schemaregistryUser:schemaregistryUser");
    envs.put("SCHEMA_REGISTRY_PASSWORD_ENCODER_SECRET", "encoder-secret");
    envs.put("SCHEMA_REGISTRY_KAFKASTORE_UPDATE_HANDLERS",
        "io.confluent.schema.exporter.storage.SchemaExporterUpdateHandler");
    envs.put("CUB_CLASSPATH",
        "/usr/share/java/confluent-security/schema-registry/*:/usr/share/java/schema-registry/*:/usr/share/java/schema-registry-plugins/*:/usr/share/java/cp-base-new/*");
    return envs;
  }
