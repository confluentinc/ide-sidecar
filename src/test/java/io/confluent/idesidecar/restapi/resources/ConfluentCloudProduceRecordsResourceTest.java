...
import static io.confluent.idesidecar.restapi.cache.ClusterCacheExpectations.*;
	...
	void testProduceRecordToConfluentCloud() {
		...
		wireMock.register(
				WireMock
						...
						.withHeader("Authorization", new EqualToPattern("Bearer %s".formatted(dataPlaneToken.token())))
						.willReturn(
								WireMock.aResponse()
										.withStatus(200)
										...
										.withBody(
												loadResource("ccloud-produce-records-mocks/get-schema-success-response.json")
										)
						)
		);
		wireMock.register(
		...
		wireMock.register(
				WireMock
						.post("/kafka/v3/clusters/%s/topics/%s/records".formatted(KAFKA_CLUSTER_ID, "test-topic"))
						.withRequestBody(
								WireMock.equalToJson(
										loadResource("ccloud-produce-records-mocks/produce-record-expected-request.json"),
						...
						.willReturn(
								WireMock.aResponse()
										...
										.withGzipDisabled(true)
										.withBody(
												loadResource("ccloud-produce-records-mocks/produce-record-success-response.json")
										)
						)
		);
